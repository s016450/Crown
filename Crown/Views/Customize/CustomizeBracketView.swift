...
struct CustomizeBracketView: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            Text(self.userInfo.ownCompetitions[userInfo.ownCompetitions.count - 1].compName == "" ? "New Bracket Competition" : self.userInfo.ownCompetitions[userInfo.ownCompetitions.count - 1].compName)
...
struct CustomizeBracketView_Previews: PreviewProvider {
    static var previews: some View {
        CustomizeBracketView()
    }
}
